...
pubDate: "Jul 22 2023"
heroImage: "/00078-3541799576.png"
---
# 如何快速切换主题
...
{/* <a href="https://play.tailwindcss.com/uj1vGACRJA?layout=preview">
  <img src={import('@/img/typography-demo.jpg').default.src} alt="Tailwind CSS IntelliSense extension for Visual Studio Code" width={3086} height={1658} className="rounded-lg ring-1 ring-black/5" />
</a> */}
...
现在，您可以使用“prose”类将合理的排版样式添加到任何原始 HTML 中：
```html
<article class="prose lg:prose-xl">
...
### 选择灰度色阶  
该插件包括每个默认包含的五种灰度级别的修改器类，因此您可以轻松地将内容样式与项目中使用的灰度匹配。  
```html
...
<p>Always include the `prose` class when adding a gray scale modifier</p>
...
{/* <p>Always include the `prose` class when adding a size modifier</p> */}
